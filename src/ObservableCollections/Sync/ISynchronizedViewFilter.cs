...
public static class SynchronizedViewFilterExtensions
{
    ...
    public static void AttachFilter<T, TView>(this ISynchronizedView<T, TView> source, Func<T, TView, bool> isMatch,
        Action<T, TView>? whenTrue, Action<T, TView>? whenFalse)
    {
    ...
    internal static void InvokeOnAdd<T, TView>(this ISynchronizedViewFilter<T, TView> filter,
        (T value, TView view) value, int index)
    {
        ...
        int index)
    {
        ...
        filter.OnCollectionChanged(new SynchronizedViewChangedEventArgs<T, TView>(NotifyCollectionChangedAction.Add,
            value, newView: view, newViewIndex: index));
    }

    internal static void InvokeOnRemove<T, TView>(this ISynchronizedViewFilter<T, TView> filter,
        (T value, TView view) value, int oldIndex)
    {
    ...
    internal static void InvokeOnRemove<T, TView>(this ISynchronizedViewFilter<T, TView> filter, T value, TView view,
        int oldIndex)
    {
        filter.OnCollectionChanged(new SynchronizedViewChangedEventArgs<T, TView>(NotifyCollectionChangedAction.Remove,
            oldValue: value, oldView: view, oldViewIndex: oldIndex));
    }

    internal static void InvokeOnMove<T, TView>(this ISynchronizedViewFilter<T, TView> filter,
        (T value, TView view) value, int index, int oldIndex)
    {
    ...
    {
        filter.OnCollectionChanged(new SynchronizedViewChangedEventArgs<T, TView>(NotifyCollectionChangedAction.Move,
            value, newView: view, newViewIndex: index, oldViewIndex: oldIndex));
    }

    internal static void InvokeOnReplace<T, TView>(this ISynchronizedViewFilter<T, TView> filter,
        (T value, TView view) value, (T value, TView view) oldValue, int index, int oldIndex = -1)
    {
        filter.InvokeOnReplace(value.value, value.view, oldValue.value, oldValue.view, index, oldIndex);
    }

    internal static void InvokeOnReplace<T, TView>(this ISynchronizedViewFilter<T, TView> filter, T value, TView view,
        T oldValue, TView oldView, int index, int oldIndex = -1)
    {
        filter.OnCollectionChanged(new SynchronizedViewChangedEventArgs<T, TView>(NotifyCollectionChangedAction.Replace,
            value, newView: view, oldValue: oldValue, oldView: oldView, newViewIndex: index,
            oldViewIndex: oldIndex >= 0 ? oldIndex : index));
    }
